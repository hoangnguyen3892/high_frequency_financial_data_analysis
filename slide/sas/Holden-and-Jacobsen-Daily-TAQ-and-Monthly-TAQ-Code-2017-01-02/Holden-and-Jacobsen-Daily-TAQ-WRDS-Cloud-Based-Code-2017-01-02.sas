/* HOLDEN AND JACOBSEN DAILY TAQ (DTAQ) WRDS CLOUD-BASED CODE 2017-01-02 

   Our SAS code selects the Daily TAQ (DTAQ) data that you want, creates
   the official complete National Best Bid and Offer (NBBO), computes
   standard liquidity measures, and downloads the output files to a PC. 
   It was last updated on January 2, 2017.
   ...
   Our code creates the nine WORK files listed below in the WRDS Cloud. In the   
   last step, choose files to output to your WRDS cloud data library. 
...
/*data project.TradesandCorrespondingNBBO;set TradesandCorrespondingNBBO;run;*/
...
data project.RealizedSpreadsandPriceImpacts;set RealizedSpreadsandPriceImpacts;run;

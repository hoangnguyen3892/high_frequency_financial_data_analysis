/* HOLDEN AND JACOBSEN MONTHLY TAQ (MTAQ) WRDS CLOUD-BASED CODE 2016-07-21 

   Our SAS code selects the Monthly TAQ (MTAQ) data that you want from WRDS,
   computes the National Best Bid and Offer (NBBO), computes standard 
   liquidity measures, and downloads the output files to a PC. It was last
